...
lv_obj_t * lv_demo_music_main_create(lv_obj_t * parent, file_iterator_instance_t *file_iterator_i)
{
    LV_LOG_INFO("lv_demo_music_main_create");

    file_iterator = file_iterator_i;
    if (file_iterator == NULL) {
        LV_LOG_ERROR("file_iterator is NULL");
        return NULL;
    }

    /*Set the default fonts for the music demo*/
